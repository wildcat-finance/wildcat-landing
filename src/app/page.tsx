                        ...
                        <div className='col-span-6 grid grid-cols-12'>
                            <div className='col-span-4'>
                                <ul>
                                    ...
                                    <li><a href={"#"} target={'_blank'}
                                           rel='noopener noreferrer'>Overview</a></li>
                                    <li><a href={"#"} target={'_blank'}
                                           rel='noopener noreferrer'>How it works</a></li>
                                    <li><a href={"#"} target={'_blank'}
                                           rel='noopener noreferrer'>Apply</a></li>
                                    <li><a href={"#"} target={'_blank'}
                                           rel='noopener noreferrer'>Use cases</a></li>
                                    <li><a href={"#"} target={'_blank'}
                                           rel='noopener noreferrer'>Audits</a></li>
                                    <li><a href={"#"} target={'_blank'}
                                           rel='noopener noreferrer'>Manifesto</a></li>
                                </ul>
                            </div>
                            <div className='col-span-4'>
                                <ul>
                                    <li className='py-3 font-bold'>Docs</li>
                                    <li><a href={"https://github.com/wildcat-finance/wildcat-whitepaper"} target={'_blank'}
                                           rel='noopener noreferrer'>Whitepaper</a></li>
                                    <li><a href={"#"} target={'_blank'}
                                           rel='noopener noreferrer'>Gitbook</a></li>
                                    {/*<li>Media Kit</li>*/}
                                    <li><a href={"#"} target={'_blank'}
                                           rel='noopener noreferrer'>Audits</a></li>
                                </ul>
                            ...
                            <div className='col-span-4'>
                                <ul>
                                    ...
                                    <li><a href={"#"} target={'_blank'}
                                           rel='noopener noreferrer'>Legal Notice</a></li>
                                    <li><a href={"#"} target={'_blank'}
